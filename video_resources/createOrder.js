...
const DISH_ORDER_TABLE = "<dish_order_table name>";
 ...
 * Create an order
 * Link dishes to the order - Users can see the past orders and admins can view orders by user
